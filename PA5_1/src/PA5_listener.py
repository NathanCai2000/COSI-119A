...
# the param turtle (default to turtle2)
    ...
    pos = int(turtle_name[-1:])
    follow_name = rospy.get_param('~follow', 'turtle1')
    spawner(pos, 2, 0, turtle_name)
...
# This is the most important line. Requests the transform between turtle1 and turtle_name
            trans = tfBuffer.lookup_transform(turtle_name, follow_name, rospy.Time())
